<template>
    ...
    >
        <v-list v-model:opened="state.open" nav>
            <v-list-item>
                <Link class="v-list-item-title v-list-item--variant-text" :href="route('backend.dashboard')">
                    Softwind Tech
                </Link>
            </v-list-item>
            <v-divider></v-divider>
            ...
            <v-list-item prepend-icon="mdi-home">
                <Link class="v-list-item-title v-list-item--variant-text" :href="route('backend.dashboard')">Dashboard</Link>
            </v-list-item>
            ...
            <!--            <v-list-group :value="state.product.title">-->
            <!--                <template v-slot:activator="{ props }">-->
            <!--                    <v-list-item-->
            <!--                        v-bind="props"-->
            <!--                        :prepend-icon="state.product.icon"-->
            ...
            <!--            <v-list-group :value="state.settings.title">-->
            <!--                <template v-slot:activator="{ props }">-->
            <!--                    <v-list-item-->
            <!--                        v-bind="props"-->
            <!--                        :prepend-icon="state.settings.icon"-->
            <!--                        :title="state.settings.title"-->
            <!--                    ></v-list-item>-->
            <!--                </template>-->

            <!--                <v-list-item-->
            <!--                    v-for="([title, icon, routeName], i) in state.settings.menus"-->
            <!--                    :key="i"-->
            <!--                    :value="title"-->
            <!--                    :prepend-icon="icon"-->
            <!--                    class="pa-0"-->
            ...
            <v-list-item prepend-icon="mdi-cog">
                <Link class="v-list-item-title v-list-item--variant-text"
                      :href="route('backend.store-details.index')">Settings</Link>
            </v-list-item>
        </v-list>
    </v-navigation-drawer>
</template>
...
const state = reactive({
    ...
    orders: {
        ...
        icon: 'mdi-cart',
        menus: [
            ['Order List', 'mdi-circle-small', 'backend.product.index'],
            ['Customer List', 'mdi-circle-small', 'backend.product.index'],
            ['Inventory', 'mdi-circle-small', 'backend.product.index'],
        ],
    },
})
</script>
