            ...
            <v-col cols="12">
                <v-card>
                    <CardTitle
                        ...
                        icon="mdi-plus"
                        :router="{title:'Add New', route:'backend.taxes.create', queryParam:$page.props.auth.tenant}"
                    />
                                ...
                                <tr v-for="(item, index) in items.data" :key="index">
                                    ...
                                    <td class="text-center">
                                        <Link
                                            ...
                                            :href="route('backend.taxes.edit', [$page.props.auth.tenant, item.id])">
                                            <i class="mdi-pencil mdi v-icon" aria-hidden="true"></i>
                                        </Link>

                                        <Delete :id="item.id" :routeName="'backend.taxes.destroy'" :tenantName="$page.props.auth.tenant"/>
                                    </td>
                                </tr>
                            </tbody>
                        </v-table>
