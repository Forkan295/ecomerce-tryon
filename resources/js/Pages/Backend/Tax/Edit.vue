                        ...
                        <v-row>
                            <v-col cols="8">
                                <v-card-item>
                                    ...
                                    <Input type="number" label="Percentage" v-model="form.percentage" :error-messages="form.errors.percentage" />
                                    <Input type="number" label="Priority" v-model="form.priority" :error-messages="form.errors.priority" />
                                </v-card-item>
                            </v-col>
...
<script setup>
    ...
    const submit = () => {
        form.put(route('backend.taxes.update', [tenant, props.tax.id]), {
            onSuccess: (success) => {
