            ...
            <v-col cols="12">
                <v-card>
                    <CardTitle
                        title="Roles"
                        icon="mdi-plus"
                        :router="{title:'Add New', route:'backend.role.create'}"
                    />
                    ...
                    <v-card-text>
                        <v-table>
                            ...
                            <tr v-for="(item, index) in roles.data" :key="index">
                                ...
                                <td class="w-25">
                                    <span v-if="item.permissions.length > 0" v-for="permission in item.permissions">
                                        <v-badge class="my-1" :content="permission.name" color="green" inline></v-badge>
                                    </span>
                                    <div v-else>N/A</div>
                                </td>
