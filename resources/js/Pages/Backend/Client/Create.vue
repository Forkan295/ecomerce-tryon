                            ...
                            <v-col cols="4">
                                ...
                                <v-card-item>
                                    <v-card-title class="mb-3">
                                        Additional Permissions <input type="checkbox" @click="loadMore($event)">
                                    </v-card-title>
                                        ...
                                        <v-table
                                            ...
                                            <tbody>
                                                <tr v-for="(permission, index) in data.permissions.data"
                                                    ...
                                                    <td>
                                                        <p><label :for="permission.display_name">{{ permission.display_name }}</label></p>
                                                    </td>
                                                    <td>
                                                        <p><label :for="permission.display_name">{{ permission.name }}</label></p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </v-table>
