            ...
            <v-col cols="12">
                <v-card>
                    <CardTitle
                        ...
                        icon="mdi-plus"
                        :router="{title:'Add New', route:'backend.category-types.create', queryParam:$page.props.auth.tenant}"
                    />
                                ...
                                <tr v-for="(item, index) in items.data" :key="index">
                                    ...
                                    <td class="text-center">
                                        <Link
                                            ...
                                            :href="route('backend.category-types.edit', [$page.props.auth.tenant, item.id])">
                                            <i class="mdi-pencil mdi v-icon" aria-hidden="true"></i>
                                        </Link>

                                        <Delete :id="item.id" :routeName="'backend.category-types.destroy'" :tenantName="$page.props.auth.tenant"/>
                                    </td>
                                </tr>
                            </tbody>
                        </v-table>
